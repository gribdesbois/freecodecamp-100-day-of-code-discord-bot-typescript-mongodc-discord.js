  ...
  run: async (interaction) => {
    ...
    if (!targetCamper.day) {
      await interaction.editReply({
        content:
          'It looks like you have not started the 100 Days of Code challenge yet. Use /100 and add your message yo report your first day!',
      })
      return
    }

    const camperEmbed = new MessageEmbed()
    camperEmbed.setTitle('My 100 Doc Progress')
